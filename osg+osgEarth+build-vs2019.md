...
sqlite官网https://sqlite.org/download.html 

下载sqlite3, https://sqlite.org/2020/sqlite-amalgamation-3310100.zip ，要下载amalgamation版的
...
官网http://www.libtiff.org/  

下载最新版 http://download.osgeo.org/libtiff/tiff-4.1.0.zip
...
> mkdir buildms
> cd buildms
buildms> cmake -DCMAKE_INSTALL_PREFIX=C:/tools/vs2019 -DTIFF_INCLUDE_DIR="C:/tools/vs2019/include" -DBUILD_TESTING=no -DTIFF_LIBRARY="C:/tools/vs2019/lib/tiff.lib" -DCURL_INCLUDE_DIR="C:/tools/vs2019/include" -DCURL_LIBRARY="C:/tools/vs2019/lib/libcurl_imp.lib" -DSQLITE3_INCLUDE_DIR="C:/tools/vs2019/include" -DSQLITE3_LIBRARY="C:/tools/vs2019/lib/sqlite3.lib" ..
buildms> msbuild ALL_BUILD.vcxproj /p:Configuration="Release"
buildms> msbuild INSTALL.vcxproj /p:Configuration="Release"
````
...
修改`geos\tools\astyle\ASLocalizer.cpp`文件，将编码改为ANSI。

```
> cd /path/to/geos
> mkdir buildms
> cd buildms
> buildms> cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX="c:/tools/vs2019" -DBUILD_TESTING=NO ..
...
PROJ_LIBRARY = c:\tools\vs2019\lib\proj.lib
```
...
```
GEOS_DIR=C:/tools/vs2019
GEOS_CFLAGS = -I$(GEOS_DIR)/include -DHAVE_GEOS
GEOS_LIB     = $(GEOS_DIR)/source/geos_c.lib
```

添加`SHELLLIB `

```
SHELLLIB = "C:\Program Files (x86)\Windows Kits\10\Lib\10.0.18362.0\um\x64\shell32.lib"
```

修改`EXTERNAL_LIBS`，添加

```
EXTERNAL_LIBS =	$(CPLLIB) $(SHELLLIB) \
```
...
```
> cd gdal
gdal> nmake -f makefile.vc MSVC_VER=1920 
...
选一个下载 http://www.zlib.net/zlib1211.zip
...
选一个下载 http://prdownloads.sourceforge.net/libpng/lpng1637.zip?download
...
官网 https://www.freetype.org/download.html 

找个链接下载  https://download.savannah.gnu.org/releases/freetype/freetype-2.10.0.tar.gz
...
> mkdir buildms
> cd buildms
buildms> cmake -DCMAKE_INSTALL_PREFIX="c:/tools/vs2019" -DBUILD_DOCUMENTATION=yes -DACTUAL_3RDPARTY_DIR="c:/tools/vs2019" ..
```
...
expat在Github有项目 https://github.com/libexpat/libexpat 

下载源码 https://github.com/libexpat/libexpat.git
...
osgearth有Github工程 https://github.com/gwaldron/osgearth 

下载其源码 https://github.com/gwaldron/osgearth.git

commit:16596ed87929fcabc6d00efa2f216f806deac832
...
> mkdir buildms
> cd buildms
buildms> cmake -DCMAKE_INSTALL_PREFIX="c:/tools/vs2019" -DTHIRD_PARTY_DIR="c:/tools/vs2019" ..
buildms> msbuild ALL_BUILD.vcxproj /m /p:Configuration="Release"
buildms> msbuild INSTALL.vcxproj /p:Configuration="Release"
```
