...
namespace osgEarth { namespace Contrib
{
    ...
    public:
         ...
         *     for the readout.
         */
        MouseHandler( MapNode* mapNode, LabelControl* label =0L, Formatter* formatter =0L );
     ...
     */
    class MouseHandlerCallback : public MouseHandler::Callback
    {
    public:
        MouseHandlerCallback( LabelControl* label, Formatter* formatter =0L );

        virtual ~MouseHandlerCallback() { }
